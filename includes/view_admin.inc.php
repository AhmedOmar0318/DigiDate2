<div class="container mx-auto p-4">
    ...
    <div class="w-full overflow-x-auto">
        <table class="w-full bg-white shadow-md rounded">
            ...
            <tr>
                <th class="py-3 px-4 uppercase font-semibold text-sm w-1/5 text-left">Firstname</th>
                <th class="py-3 px-4 uppercase font-semibold text-sm w-1/5 text-left">Middlename</th>
                <th class="py-3 px-4 uppercase font-semibold text-sm w-1/5 text-left">Lastname</th>
                <th class="py-3 px-4 uppercase font-semibold text-sm w-1/5 text-left">Email</th>
                <th class="py-3 px-4 uppercase font-semibold text-sm w-1/5 text-left">Actions</th>
            </tr>
            </thead>
            <tbody>
