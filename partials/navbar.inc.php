    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center space-x-4">
                <?php if (!$isAdmin): ?>
                    <a href="index.php?page=find_match"
                       class="bg-white text-purple-600 hover:bg-purple-100 px-4 py-2 rounded-full text-sm font-medium transition duration-150 ease-in-out">
                        Vind een match!
                    </a>
                <?php endif; ?>
